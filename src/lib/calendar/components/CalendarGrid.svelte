...
<!-- Full width — headers and cells share the same 7-column grid so they always align -->
<div class="flex flex-col gap-0.5 w-full">
	...
	<!-- Day cells — aspect-ratio keeps them square regardless of page width -->
		...
		{#each days as day (day.date)}
			<button
				...
				class="relative flex flex-col items-center justify-center rounded-lg
				       ...
				       {!day.isPadding && !day.isFuture ? 'cursor-pointer hover:bg-[var(--color-surface-800)]' : ''}
