...
<div class="w-full" style="perspective: 1000px; height: 260px; overflow: hidden;">
	...
	>
		<!-- Front face -->
		<div
			class="absolute inset-0 flex flex-col rounded-xl border border-[var(--color-surface-700)]
				...
				{#if frontImageUrl}
					<div class="flex items-center justify-center overflow-hidden" style="max-height: 100px; width: 100%;">
						<img src={frontImageUrl} alt="Front"
							class="rounded-lg border border-[var(--color-surface-700)]"
		...
		<!-- Back face -->
		<div
			class="absolute inset-0 flex flex-col rounded-xl border border-[var(--color-accent-500)]/30
			       bg-[var(--color-surface-800)] p-5 overflow-hidden"
